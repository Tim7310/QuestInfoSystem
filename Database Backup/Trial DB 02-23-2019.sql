...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2019 at 06:07 AM
...
(88, 119, 113, '5.8', '145', 'F:112-157', '0.44', ' F:0.34-0.45', '62', '29', '11', 'NORMAL', '', '', '', '', 5, 2, 4, '2019-02-22 13:42:18', '0000-00-00 00:00:00'),
...
(94, 131, 125, '6.1', '149', 'M:137-175', '0.45', ' M:0.40-0.51', '50', '39', '11', 'NORMAL', '', '', '', '', 5, 2, 4, '2019-02-23 11:16:16', '0000-00-00 00:00:00'),
...
(74, 119, 113, 'N/A', 'N/A', 'N/A', 'NO SPX', 'YELLOW', 'SL. TURBID', '5.0', '1.025', 'Negative', 'Negative', '0-3', '0-3', 'NONE', 'Moderate', 'Moderate', 'NONE', 'NONE', 'NORMAL', '', '', '', '', '', '', 'N/A', 5, 2, 4, '2019-02-22 13:42:18', '0000-00-00 00:00:00'),
(75, 116, 110, 'N/A', 'N/A', 'N/A', 'NO SPX', 'LIGHT YELLOW', 'HAZY', '7.0', '1.010', 'Negative', 'Negative', '0-2', '0-3', 'NONE', 'Rare', 'Moderate', 'NONE', 'NONE', 'NORMAL', '', '', '', '', '', '', 'N/A', 5, 2, 4, '2019-02-22 13:44:36', '0000-00-00 00:00:00'),
...
(78, 131, 125, 'N/A', 'N/A', 'N/A', '', 'LIGHT YELLOW', 'CLEAR', '6.0', '1.015', 'Negative', 'Negative', '1-2', '1-2', 'Rare', 'Rare', 'Rare', 'NONE', 'NONE', 'NORMAL', '', '', '', '', '', '', 'N/A', 5, 2, 4, '2019-02-23 11:16:16', '0000-00-00 00:00:00'),
...
(1, 5, 2, 'NONREACTIVE', '', '', 5, 1, 2, '2019-02-18 15:40:43', '2019-02-18 16:30:39'),
...
(63, 119, 113, 'NONREACTIVE', '', 'NORMAL', 5, 2, 4, '2019-02-22 13:42:18', '0000-00-00 00:00:00'),
(64, 116, 110, 'NONREACTIVE', '', 'NORMAL', 5, 2, 4, '2019-02-22 13:44:36', '0000-00-00 00:00:00'),
(65, 120, 114, 'N/A', '', '', 5, 2, 4, '2019-02-22 14:23:56', '2019-02-22 15:45:36'),
(66, 121, 115, 'N/A', '', '', 5, 2, 4, '2019-02-22 16:26:05', '2019-02-22 16:36:22'),
(67, 131, 125, 'N/A', '', '', 5, 2, 4, '2019-02-23 11:16:16', '0000-00-00 00:00:00'),
...
(0, 5, 2, 'NEGATIVE', 'NEGATIVE', 'NEGATIVE', 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(22, 0000000000074, 68, 'Pending - These are cases that are equivocal as to the classification and are being evaluated further. After a certain period of time these cases will be classified whether fit or unfit fot employment', 'NO STOOL', '', 0, '2019-02-21'),
...
(37, 0000000000100, 94, 'Pending - These are cases that are equivocal as to the classification and are being evaluated further. After a certain period of time these cases will be classified whether fit or unfit fot employment', 'NO STOOL', '', 0, '2019-02-21'),
(38, 0000000000099, 93, 'Pending - These are cases that are equivocal as to the classification and are being evaluated further. After a certain period of time these cases will be classified whether fit or unfit fot employment', 'NO STOOL', '', 0, '2019-02-21'),
...
(65, 0000000000116, 110, 'Pending - These are cases that are equivocal as to the classification and are being evaluated further. After a certain period of time these cases will be classified whether fit or unfit fot employment', 'NO STOOL; NO DT RESULT', '', 0, '2019-02-22'),
(66, 0000000000119, 113, 'Pending - These are cases that are equivocal as to the classification and are being evaluated further. After a certain period of time these cases will be classified whether fit or unfit fot employment', 'NO DT RESULT NO STOOL', '', 0, '2019-02-22');
...
--
ALTER TABLE `lab_hematology`
  MODIFY `hemaID` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;

--
-- AUTO_INCREMENT for table `lab_microscopy`
--
ALTER TABLE `lab_microscopy`
  MODIFY `microID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `lab_serology`
  MODIFY `seroID` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `qpd_class`
  MODIFY `ClassID` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `qpd_medhis`
  MODIFY `MedHisID` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT for table `qpd_patient`
--
ALTER TABLE `qpd_patient`
  MODIFY `PatientID` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
...
--
ALTER TABLE `qpd_pe`
  MODIFY `PExamID` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `qpd_trans`
  MODIFY `TransactionID` int(13) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;

--
-- AUTO_INCREMENT for table `qpd_vital`
--
ALTER TABLE `qpd_vital`
  MODIFY `VitalsID` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;

--
-- AUTO_INCREMENT for table `qpd_xray`
--
ALTER TABLE `qpd_xray`
  MODIFY `XrayID` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `user_privilege`
  MODIFY `privID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
