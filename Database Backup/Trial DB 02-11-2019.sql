...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2019 at 01:45 AM
...
(3, 18, 15, 2, 'HEMATOLOGY'),
(4, 20, 17, 3, 'MICROSCOPY'),
(5, 21, 18, 5, 'CHEMISTRY'),
...
(0000000000014, '60958247', 11, 'CASH', 'Timothy', '316,304,478,422,325', '1,1,1,1,1', 'ANN MITZEL G. MATA OCAMPO, MD, DPDS', '656', '0', '20,20,20,20,20', '0', '656', '2019-02-08 09:34:10', 0, 'sales'),
...
(0000000000022, '45069218', 19, '', 'Timothy', '422,358', '1,1', 'YOKOHAMA', '', '', '0,0', '', '', '2019-02-09 09:15:46', 0, 'sales'),
...
(0000000000030, '10984752', 0, '', 'Timothy', '304', '1', '', '', '', '0', '', '', '2019-02-11 08:32:09', 0, 'sales');
...
INSERT INTO `xray_markers` (`markerID`, `PatientID`, `TransactionID`, `xrayFilm`, `totalCount`) VALUES
(0, 11, 14, '11x14', 0);
...
--
ALTER TABLE `lab_chemistry`
  MODIFY `chemID` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `lab_hematology`
--
ALTER TABLE `lab_hematology`
  MODIFY `hemaID` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `lab_microscopy`
--
ALTER TABLE `lab_microscopy`
  MODIFY `microID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `print_count`
  MODIFY `PrintID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `qpd_items`
  MODIFY `ItemID` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=566;
...
--
ALTER TABLE `qpd_patient`
  MODIFY `PatientID` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `qpd_trans`
  MODIFY `TransactionID` int(13) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
