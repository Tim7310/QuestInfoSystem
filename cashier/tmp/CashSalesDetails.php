...
<div class="container" style="margin-top: 10px;">
	<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					$select = "SELECT * FROM qpd_trans t, qpd_patient p WHERE t.TransactionDate >= '$SD' AND t.TransactionDate <= '$ED' AND t.TransactionType = 'CASH' AND p.PatientID = t.PatientID";
