...
<div class="row">
    <div class="col-md-10 offset-sm-1">
        <div class="card" style="border-radius: 0px; margin-top: 10px;">
            ...
            <form action="TransTypePay.php" method="get" autocomplete="off" enctype="multipart/form-data" onsubmit="return CheckValues()">	
            <div class="row">
					<div class="col-3">
						Customer Name:<br>
						Company:<br>
			...
			<div class="row">
				...
				<div class="col">
					<center>
						...
						<input type="submit" class="btn btn-primary" name="transtype" value="CASH">
					</center>
				</div>
			</div>
            </form>
