...
else
{
	...
	else
	{
		...
		if (!empty($check)) 
		{
			...
			header('Location: Cash.php?id='.$finalRef); 
    ...
    <div class="card-block" style="height: 130px;" >
			<div class="row">
            	<div class="col" >
            				...
            				<form method="POST" >
								  ...
								  <input type="submit" class="fa fa-input" name="item" value="ADD">	
			...
			<div class="col" style="margin-left: 300px;">
            	<form method="POST">
					...
					<button type="button" class="btn btn-primary" style="height: 40px; width: 180px; font-size: 15px;" data-toggle="modal" data-target="#ModalAdd"><i class="fas fa-user-circle"></i>&nbsp; Add New Patient</button>
            		<input type="submit" name="SEARCHPATX" style="height: 40px;" class="btn btn-primary fa fa-input" value="&#xf002&nbsp; SEARCH">
...
<hr>
 <div class="row">
	<div class="col-8">
	<input class="btn btn-primary fa fa-input" type="submit" name="btnPayout" id="btnPayout" value="&#xf0d6&nbsp; CASH" style="margin-right: 10px; font-size: 16px; width: 100px; height: 40px; background-color:  #0260B0;">
	<!-- <form action="finaltrans.php" method="POST">
	<input class="btn btn-primary fa fa-input" type="submit" name="" id="" value="&#xf09d&nbsp; ACCOUNT" style="margin-right: 10px; font-size: 16px; width: 150px; height: 40px; background-color:  #0260B0;">
	</form> -->
	</div>
</form>
	<div class="col-2">
	  ...
	  $GrandTotal = $result['GrandTotal'];
		...
		if ($total>$AmountRes) 
		{
 		...
 		else
 		{
		    ...
		    {
		    	echo "<script>window.open('Cash.php?id=$id','_self')</script>";
		    }
		  	else
		  	{
		      echo "Error updating record: " . $con->error;
...
<hr>
 <div class="row">
	...
	<div class="col-2">
	<form action="finaltrans.php" method="POST">
		<button type="button" class="btn btn-primary" name="CASH" style="margin-left: 10px; font-size: 18px; width: 190px; height: 40px;" data-toggle="modal" data-target="#myModal"><i class="fas fa-print"></i>&nbsp; SAVE AND PRINT</button>
