...
<div class="container-fluid">
	<div class="col-5">
		...
		<br>
		<div class="row">
			<div class="col"><b class="info" style="font-size: 14px;"><?php echo $data['lasnam'] ?>, <?php echo $data['firnam'] ?> <?php echo $data['midnam'] ?></b></div>
		</div>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-2">Php<?php echo $data['cust_cash'] ?></div>
		</div>
		<div class="row">
			<div class="col-8 text-right">Given Change:</div>
			<div class="col-2">Php<?php echo $data['cust_change'] ?></div>
		</div>
		<br>
		<div class="row">
