        ...
        <div class="card" style="border-radius: 0px; margin-top: 10px;">
            ...
            <div class="card-block">
            	<div class="row">
					...
					<div class="col-2">
						<input type="text" class="form-control" name="height" style="width: 60px !important;">
					</div>
					<div class="col-2 text-right">
						<label>Weight:</label>
					</div>
					<div class="col-2">
						<input type="text" class="form-control" name="weight" style="width: 60px !important;">
					</div>
					<div class="col-2 text-right">
						<label>BMI:</label>
					</div>
					<div class="col-2">
						<input type="text" class="form-control"  name="bmi" id="bmi" style="width: 60px !important;">
					</div>
				</div>
				<div class="row">
					<div class="col-2 text-right">
					...
					<div class="col-2">
						<input type="text" class="form-control"  name="bp" style="width: 60px !important;">
					</div>
					<div class="col-2 text-right">
						<label>PR:</label>
					</div>
					<div class="col-2">
						<input type="text" class="form-control"  name="pr" style="width: 60px !important;">
					</div>
					<div class="col-2 text-right">
						<label>RR:</label>
					</div>
					<div class="col-2">
						<input type="text" class="form-control"  name="rr" style="width: 60px !important;">
					</div>
				</div>
				<div class="row">
					<div class="col">
				...
				<div class="row">
					...
					<div class="col-3">
						<input type="text" class="form-control"  name="uod" style="max-width: 100px !important;">
					</div>
					<div class="col-1">
						<label>OS:</label>
					</div>
					<div class="col-3">
						<input type="text" class="form-control"  name="uos" style="max-width: 100px !important;">
					</div>
				</div>
				<div class="row">
					<div class="col-4">
					...
					<div class="col-3">
						<input type="text" class="form-control"  name="cod" style="max-width: 100px !important;">
					</div>
					<div class="col-1">
						<label>OS:</label>
					</div>
					<div class="col-3">
						<input type="text" class="form-control"  name="cos" style="max-width: 100px !important;">
					</div>
				</div>
				<div class="row">
					<div class="col-4">
