...
<div class="container" style="margin-top: 10px;">
	<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tr>
							...
							<td > 
								<button type="button" class="btn btn-primary" onclick="window.open('ClassificationInput.php?id=<?php echo $patient['PatientID']?>&tid=<?php echo $patient['TransactionID']?>');">Classify Patient</button>
							</td>
                ...
                buttons: [
                    {
                        ...
                        action: function ( e, dt, node, config ) {
						   ...
						   "ClassificationList.php?month=1&year=<?php echo $year ?>";
                        }
                    },
                    {
                        text: 'February',
                        action: function ( e, dt, node, config ) {
						   window.location.href = 
						   "ClassificationList.php?month=2&year=<?php echo $year ?>";
                        }
            		},
            		{
                        text: 'March',
                        action: function ( e, dt, node, config ) {
						   window.location.href = 
						   "ClassificationList.php?month=3&year=<?php echo $year ?>";
                        }
            		},
            		{
                        text: 'April',
                        action: function ( e, dt, node, config ) {
						   window.location.href = 
						   "ClassificationList.php?month=4&year=<?php echo $year ?>";
                        }
                    },
                    {
                        text: 'May',
                        action: function ( e, dt, node, config ) {
						   window.location.href = 
						   "ClassificationList.php?month=5&year=<?php echo $year ?>";
                        }
            		},
            		{
                        text: 'June',
                        action: function ( e, dt, node, config ) {
						   window.location.href = 
						   "ClassificationList.php?month=6&year=<?php echo $year ?>";
                        }
            		},
            		{
                        text: 'July',
                        action: function ( e, dt, node, config ) {
						   window.location.href = 
						   "ClassificationList.php?month=7&year=<?php echo $year ?>";
                        }
                    },
                    {
                        text: 'August',
                        action: function ( e, dt, node, config ) {
						   window.location.href = 
						   "ClassificationList.php?month=8&year=<?php echo $year ?>";
                        }
            		},
            		{
                        text: 'September',
                        action: function ( e, dt, node, config ) {
						   window.location.href = 
						   "ClassificationList.php?month=9&year=<?php echo $year ?>";
                        }
            		},
            		{
                        text: 'October',
                        action: function ( e, dt, node, config ) {
						   window.location.href = 
						   "ClassificationList.php?month=10&year=<?php echo $year ?>";
                        }
                    },
                    {
                        text: 'November',
                        action: function ( e, dt, node, config ) {
						   window.location.href = 
						   "ClassificationList.php?month=11&year=<?php echo $year ?>";
                        }
            		},
            		{
                        text: 'December',
                        action: function ( e, dt, node, config ) {
						   window.location.href = 
						   "ClassificationList.php?month=12&year=<?php echo $year ?>";
                        }
            		}
            		]
           }
