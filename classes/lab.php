...
class lab {
 ...
 //    public function fetch_data3($id, $tid){
	...
	public function addHema($tid, $pid, $WhiteBlood, $Hemoglobin, $HemoNR, $Hematocrit, $HemaNR, $Neutrophils, $Lymphocytes, $Monocytes, $CBCOt, $EOS, $BAS, $CBCRBC, $PLT, $PTime, $PTControl, $ActPercent, $INR, $PR131, $APTTime, $APTControl, $PathID, $MedID, $QualityID, $Date, $PTimeNV="", $PTControlNV="", $ActPercentNV="", $INRNV="", $APTTimeNV="", $APTControlNV="",$MS="", $ESR="", $ESRMethod=""){
		global $pdo;
		$sql = $pdo->prepare("INSERT INTO lab_hematology (TransactionID, PatientID, WhiteBlood, Hemoglobin, HemoNR, Hematocrit, HemaNR, Neutrophils, Lymphocytes, Monocytes, CBCOt, EOS, BAS, CBCRBC, PLT, PTime, PTControl, ActPercent, INR, PR131, APTTime, APTControl, PTimeNV, PTControlNV, ActPercentNV, INRNV, APTTimeNV, APTControlNV, MS, ESR, ESRMethod, PathID, MedID, QualityID, CreationDate) values ('$tid', '$pid', '$WhiteBlood', '$Hemoglobin', '$HemoNR', '$Hematocrit',' $HemaNR', '$Neutrophils', '$Lymphocytes', '$Monocytes', '$CBCOt', '$EOS', '$BAS', '$CBCRBC', '$PLT', '$PTime', '$PTControl', '$ActPercent', '$INR', '$PR131', '$APTTime', '$APTControl', '$PTimeNV', '$PTControlNV', '$ActPercentNV', '$INRNV', '$APTTimeNV', '$APTControlNV', '$MS', '$ESR', '$ESRMethod', '$PathID', '$MedID', '$QualityID', '$Date')");
		$sql->execute();
	}
	public function updateHema($tid, $pid, $WhiteBlood, $Hemoglobin, $HemoNR, $Hematocrit, $HemaNR, $Neutrophils, $Lymphocytes, $Monocytes, $CBCOt, $EOS, $BAS, $CBCRBC, $PLT, $PTime, $PTControl, $ActPercent, $INR, $PR131, $APTTime, $APTControl, $PathID, $MedID, $QualityID, $Date, $PTimeNV="", $PTControlNV="", $ActPercentNV="", $INRNV="", $APTTimeNV="", $APTControlNV="",$MS="", $ESR="", $ESRMethod=""){
		global $pdo;
		$sql = $pdo->prepare("UPDATE lab_hematology set WhiteBlood = '$WhiteBlood', Hemoglobin = '$Hemoglobin', HemoNR = '$HemoNR', Hematocrit = '$Hematocrit', HemaNR = '$HemaNR', Neutrophils = '$Neutrophils', Lymphocytes = '$Lymphocytes', Monocytes = '$Monocytes', CBCOt = '$CBCOt', EOS = '$EOS', BAS = '$BAS', CBCRBC = '$CBCRBC', PLT = '$PLT',PTime = '$PTime', PTControl = '$PTControl', ActPercent = '$ActPercent', INR = '$INR', PR131 = '$PR131', APTTime = '$APTTime', APTControl = '$APTControl' , PTimeNV = '$PTimeNV', PTControlNV = '$PTControlNV', ActPercentNV = '$ActPercentNV', INRNV = '$INRNV', APTTimeNV = '$APTTimeNV', APTControlNV = '$APTControlNV', MS = '$MS', ESR = '$ESR', ESRMethod = '$ESRMethod', PathID = '$PathID', MedID = '$MedID', QualityID = '$QualityID', CreationDate = '$Date' where PatientID = '$pid' and TransactionID = '$tid'");
		$sql->execute();
	}
