    ...
    <div class="col-md-10 offset-sm-1">
        <div class="card" style="border-radius: 0px; margin-top: 10px;">
			...
			<div class="form-group row">
	            ...
	            <div class="col-2">
	            	<input type="text" name="FBS"  class="form-control" id="FBS" value="<?php echo $data['FBS'] ?>" onchange="FBSCalc()">
	            </div>
	            <div class="col-3">
	            	mmol/L 4.1-5.9
	            </div>
			...
			<div class="form-group row">
	            ...
	            <div class="col-2">
	            	<input type="text" name="BUA"  class="form-control" id="BUA" value="<?php echo $data['BUA'] ?>" onchange="BUACalc()">
	            </div>
	            <div class="col-3">
	            	mmol/L 155 - 428
	            </div>
			...
			<div class="form-group row">
	            ...
	            <div class="col-2">
	            	<input type="text" name="BUN"  class="form-control" id="BUN" value="<?php echo $data['BUN'] ?>" onchange="BUNCalc()">
	            </div>
	            <div class="col-3">
	            	mmol/L 2.5 - 7.5
	            </div>
			...
			<div class="form-group row">
	            ...
	            <div class="col-2">
	            	<input type="text" name="CREA"  class="form-control" id="CREA" value="<?php echo $data['CREA'] ?>" onchange="CREACalc()">
	            </div>
	            <div class="col-3">
			...
			<div class="form-group row">
	            ...
	            <div class="col-2">
	            	<input type="text" name="CHOL"  class="form-control" id="CHOL" value="<?php echo $data['CHOL'] ?>" onchange="CHOLCalc()">
	            </div>
	            <div class="col-3">
	            	mmol/L < 5.17
	            </div>
			...
			<div class="form-group row">
	            ...
	            <div class="col-2">
	            	<input type="text" name="TRIG"  class="form-control" id="TRIG" value="<?php echo $data['TRIG'] ?>" onchange="TRIGCalc()">
	            </div>
	            <div class="col-3">
	            	mmol/L 0.3-1.7
	            </div>
			...
			<div class="form-group row">
	            ...
	            <div class="col-2">
	            	<input type="text" name="HDL"  class="form-control" id="HDL" value="<?php echo $data['HDL'] ?>" onchange="HDLCalc()">
	            </div>
	            <div class="col-3">
	            	mmol/L 0.9-2.21
	            </div>
			...
			<div class="form-group row">
	            ...
	            <div class="col-2">
	            	<input type="text" name="LDL"  class="form-control" id="LDL" value="<?php echo $data['LDL'] ?>" onclick="LDLCalc()">
	            </div>
	            <div class="col-3">
	            	mmol/L 2.5-4.1
	            </div>
	            <div class="col-1">
	            	<input type="text" name="LDLcon" class="form-control" id="LDLcon" value="<?php echo $data['LDLcon'] ?>" onclick="LDLconCalc()">
	            </div>
	            <div class="col-3">
	            	mg/dl 96.52-158.30
	            </div>
			...
			<div class="form-group row">
	            ...
	            <div class="col-2">
	            	<input type="text" name="CH"  class="form-control" id="CH" value="<?php echo $data['CH'] ?>" onclick ="CHCalc()">
	            </div>
	            <div class="col-3">
	            	mmol/L < 4.40 
	            </div>
			...
			<div class="form-group row">
	            ...
	            <div class="col-2">
	            	<input type="text" name="VLDL"  class="form-control" id="VLDL" value="<?php echo $data['VLDL'] ?>" onclick="VLDLCalc()">
	            </div>
	            <div class="col-3">
	            	mmol/L 0.050-1.04
	            </div>
			...
			<div class="form-group row">
	            ...
	            <div class="col">
	            	<input type="text" name="QCLIC" class="form-control"  placeholder="Quality Control License" value="<?php echo $data['QCLIC'] ?>">
	            </div>
	            <div class="col">
