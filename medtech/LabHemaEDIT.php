    ...
    <div class="col-md-10 offset-sm-1">
        <div class="card" style="border-radius: 0px; margin-top: 10px;">
			...
			<div class="form-group row ">
	            ...
	            <div class="col-2">
	            	<input type="text" name="ESR"  class="form-control" id="ESR" value="<?php echo $data['ESR'] ?>">
	            </div>
	            <div class="col-2">
	            	mm/hr
	            </div>
	            ...
	            <div class="col-3">
	            	<input type="text" name="ESRMethod"  class="form-control" id="ESRMethod" value="<?php echo $data['ESRMethod'] ?>">
	            </div>
	         </div>
			<div class="form-group row">
				<div class="col">
