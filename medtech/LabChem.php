...
<center><p>LABORATORY CHEMISTRY</p></center>
	<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tr>
							...
							<td nowrap> 
								<button type="button" class="btn btn-primary" onclick="document.location = 'LabChemVIEW.php?id=<?php echo $patient['PatientID']?>&tid=<?php echo $patient['TransactionID']?>';">VIEW RECORD</button>
