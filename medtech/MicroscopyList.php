	...
	<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tr>
							...
							<td > 
								...
								?>
								<button type="button" class="btn <?php echo $class; ?>" onclick="document.location = 'LabMicroscopyFORM.php?id=<?php echo $patient['PatientID']."&tid=".$transID[0]?>';">View Certificate</button>
							</td>
