...
if (mysqli_connect_errno())
  {
	...
	$select2 = "SELECT chnge FROM qpd_trans WHERE date >= '$SD' AND date <= '$ED'";
	...
	$select3 = "SELECT cash FROM qpd_trans WHERE date >= '$SD' AND date <= '$ED'";
...
<div class="col-4" style="padding: 0px; margin-top: 30px;">
	...
	<div class="row">
		<div class="col" style="font-size: 14px;"><center><b>SALES REPORT</b></center></div>
	</div>
	<div class="row">
		<div class="col"><center><?php echo $_GET['SD']; ?> to <?php echo $_GET['ED']; ?></center></div>
	</div>
	<div class="row">
	...
	<div class="row">
		<div class="col">
			<table>
				...
				<tbody>
				<?php
				    $select4 = "SELECT totalprice, fn, mn, ln, bill FROM qpd_trans WHERE trans_type = 'ACCOUNT' AND date >= '$SD' AND date <= '$ED'";
