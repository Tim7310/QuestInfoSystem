...
<body onload="submit()">
    ...
    $query10=mysqli_fetch_array($query9);
     echo "<h5>Report for today: ".$today."</h5>";
...
<table class="table table-hover table-striped">
    <table class="table table-striped table-condensed table2">
	 ...
	 <?php
	    ...
	    $printdate = date("Y-m-d H:i:s");
	    $today = date("Y-m-d");
	    $query1=mysqli_query($conn, "SELECT * FROM qpd_trans WHERE date like '%".$today."%' AND packid!='' AND status=0 ");
...
if(isset($_POST["ExportType"])){
    switch($_POST["ExportType"]){
        case "export-to-excel" :
		    ...
		    $printdate = date("Y-m-d H:i:s");
		    $today = date("Y-m-d");
            $filename="Sales for today (".$today.").xls";
