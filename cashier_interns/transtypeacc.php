...
<div class="row">
    <div class="col-md-10 offset-sm-1">
        <div class="card" style="border-radius: 0px; margin-top: 10px;">
            <div class="card-header card-inverse card-info"><center><b>Account Payment No.: <?php $query1=mysqli_query($conn, "SELECT * FROM qpd_trans WHERE status=0 AND id=".$_GET['id']);
